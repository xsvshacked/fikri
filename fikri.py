...
▓▓▓▓█░░░░░░░░█
███▀▀▀███████
Black Eye Community | https://github.com/xsvshacked/fikri""")
banner()

try:
	text = input("\033[1;41mTips: silahkan masukan nomor narget (+62)\033[0m\n\033[1;36m[*] Masukkan nomor hp: \033[0m")
	if text == "":
